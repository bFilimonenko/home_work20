...
// console.log((firstDigit + middleDigit + lastDigit) % 2 === 0 ? 'The sum of digits is even' : 'The sum of digits is
// odd'); console.log((firstDigit + middleDigit + lastDigit) % 5 === 0 ? 'The sum of the digits is a multiple of 5' :
// 'The sum of the digits is not a multiple of 5'); console.log((firstDigit + middleDigit + lastDigit) > 100 ? 'The
// product of digits is greater than 100' : 'The product of digits is less than 100');
